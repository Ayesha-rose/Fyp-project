    ...
    <div class="row">
      ...
      <div class="col-md-2 sidebar">
        ...
        <nav class="nav flex-column">
          <a href="/" class="nav-link active"><i class="fas fa-chart-bar"></i> Dashboard</a>
          <a href="" class="nav-link"><i class="fas fa-users"></i> Manage Users</a>
          <a href="#" class="nav-link"><i class="fas fa-tags"></i> Manage Catego</a>
          ...
          <a href="#" class="nav-link"><i class="fas fa-comment-dots"></i> Feedback</a>
        </nav>
      </div>
