...
<head>
    ...
    <title>Eduverse - Categories</title>
</head>

<body>
    <div class="categories d-flex-lg  p-0 m-0" id="home">
        <header>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo">
                        ...
                        <form class="d-flex">
                            ...
                            <a href="#" class="text-white fw-bold px-5 pt-2 text-decoration-none">Username</a>
                            <a href="logout.html" class="btn btn-white text-danger bg-white fw-bold" id="logout-btn"
